...
import com.manymonkeys.core.ii.exception.DAOException;
...
import static com.manymonkeys.core.ii.impl.cassandra.HectorUtils.ls;
import static com.manymonkeys.core.ii.impl.cassandra.HectorUtils.ss;
import static com.manymonkeys.core.ii.impl.cassandra.HectorUtils.ds;
...
public class CassandraIiDaoHectorImpl implements IiDao {
    ...
    @OwledMethod
    @Override
    public Collection<Ii> load(@OwledArgument Collection<Long> ids) {
        checkNull(ids);
