...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value="/resources/styles.css" />" type="text/css" media="screen, projection">
	...
	<!--
		<div class="container">
			...
			<div class="span-12 last">
				<form:form modelAttribute="movie" action="owls" method="post">
				  	<fieldset>
	...
	-->
	<p>
	<!--Todo Ilya Pimenov: implement sample request -->
