...
//import com.owlunit.web.model.{Person, Department}
...
//             flushRelation: (PlainMovie, Person, Department.Department) => Any
//             ) {
//
...
//        personTimer.tick(logger, 10000, "persons of department " + department)
//
//        val person = flushPerson(psPerson)
//        for (movie <- preMovies) {
//          flushRelation(movie, person, department)
//        }
//      }
//    }
//
